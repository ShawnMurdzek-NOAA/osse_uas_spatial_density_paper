...
out_fname = '../figs/VprofNoAircft.pdf'
...
sim_dict['ctrl $-$ no_aircft'] = param['sim_dict_no_aircft']['spring']
...
for istat, stat in enumerate(['RMSE']):
    ...
    for i, fhr in enumerate([0, 6]):
        ...
        for j, v in enumerate(list(plot_dict.keys())):
            ...
            # Legend
            if (i == 0) and (j == 0):
                ax.legend(ncols=3, fontsize=10, loc=(0, -1.81))
            else:
...
"""
End lower_troposphere_verif_vprofs_no_aircft.py
"""
